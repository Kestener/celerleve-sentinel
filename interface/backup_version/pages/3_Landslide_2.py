...
image = Image.open("../../data/satellite_images_train_v1/satellite_predict_test_y.jpg")
...
## Title.
st.write('# Landslide Detection')

## Pull in default image or user-selected image.
if uploaded_file is None:
    # Default image.
    url = '../../data/satellite_images_train_v1/satellite_predict_test_y.jpg'
